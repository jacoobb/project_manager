...
angular.module('app.controllers').controller('ProjectsCtrl', ['$scope', '$location', '$http', '$modal', 'TextService', 'SessionService', function ($scope, $location, $http, $modal, TextService, SessionService) {
